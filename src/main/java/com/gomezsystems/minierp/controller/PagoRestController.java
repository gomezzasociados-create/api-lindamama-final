        ...
        try {
            ...
            PreferenceRequest preferenceRequest = PreferenceRequest.builder()
                ...
                .backUrls(PreferenceBackUrlsRequest.builder()
                    .success("https://lindamama.gomezz.space/catalogo?pago=exito")
                    .failure("https://lindamama.gomezz.space/catalogo?pago=error")
                    .pending("https://lindamama.gomezz.space/catalogo?pago=pendiente")
                    .build())
                .autoReturn("approved")
